...
fn test_quarter_round() {
    let mut state = State(secret_array!(
        U32,
        [
    ...
    let expected_state = State(secret_array!(
        U32,
        [
...
fn test_kat() {
    ...
    let m = ByteSeq::from_array(&secret_bytes!([
    ...
    let exp_cipher = ByteSeq::from_array(&secret_bytes!([
