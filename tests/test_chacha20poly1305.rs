...
fn kat_test() {
    ...
    let iv = IV(secret_bytes!([
        0x07, 0x00, 0x00, 0x00, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47
    ]));
    let msg = Bytes::from_array(&secret_bytes!([
    ...
    let aad = Bytes::from_array(&secret_bytes!([
        0x50, 0x51, 0x52, 0x53, 0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7
    ]));
    let exp_cipher = Bytes::from_array(&secret_bytes!([
