...
pub fn block_init(key: Key, ctr: U32, iv: IV) -> State {
    State([
        ...
        U32(0x7962_2d32),
        U32(0x6b20_6574),
        u32_from_le_bytes(key.get(0..4)),
        u32_from_le_bytes(key.get(4..8)),
        u32_from_le_bytes(key.get(8..12)),
        u32_from_le_bytes(key.get(12..16)),
        u32_from_le_bytes(key.get(16..20)),
        u32_from_le_bytes(key.get(20..24)),
        u32_from_le_bytes(key.get(24..28)),
        u32_from_le_bytes(key.get(28..32)),
        ctr,
        u32_from_le_bytes(iv.get(0..4)),
        u32_from_le_bytes(iv.get(4..8)),
        u32_from_le_bytes(iv.get(8..12)),
    ])
}
